...
if __name__ == "__main__":
    ...
    # Usamos weakref para monitorear el ciclo de vida sin retener la referencia
    ...
    try:
        penta_roto = Pentagono("PentaRoto", "Rojo", [Lado(1.0), Lado(2.0)])
    except ValueError as e:
        print(f"Falla temprana exitosa (ValueError): {e}")